...
class CreatePlugin(RegistryMixin, ConfigMixin, ToolboxPlugin):
    ...
    def prepare_parser(self, parser):
        ...
        group.add_argument('-i',
                           '--install',
                           action='store_true',
                           help="Create and directly install new plugin")
        group.add_argument('-d',
                           '--dir',
                           type=str,
                           help='Source directory of your new plugin')

        parser.add_argument('-t',
                            '--template',
                            choices=['default', 'shell'],
                            default='default')
        parser.add_argument('name',
                            type=str,
                            help='Name of your new plugin',
    ...
    def execute(self, args):
        ...
        template_src = os.path.join(
            os.path.dirname(__file__), 'templates', args.template + ".zip")
        ...
        dest_dir = os.path.abspath(
            args.dir) if not args.dir is None else os.getcwd()
